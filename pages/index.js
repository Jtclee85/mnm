...
- 설명의 마지막에는, 사용자가 더 깊이 탐색할 수 있도록 "[NAVER에서 '핵심주제' 더 찾아보기](https://search.naver.com/search.naver?query=핵심주제)" 형식의 링크를 항상 포함합니다. 여기서 '핵심주제'는 해당 답변의 가장 중요한 키워드로 대체해야 합니다.
