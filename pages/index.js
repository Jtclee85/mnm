...
2.  **'3줄요약' 요청:** 대화 초반에 제시된 '조사 대상' 자체의 핵심 내용을 하나의 문단으로 자연스럽게 이어지는 3줄 정도 길이의 요약글로 생성해 줘. 개조식으로 작성해야 하고, 한 줄당 25자 미만의 간단한 요약글이어야 해. 항목을 나눌 수는 있지만 번호를 붙인다거나 하지는 마. **순수한 요약 내용은 반드시 <summary>와 </summary> 태그로 감싸야 해.**
      ...
      <div style={{ maxWidth: 700, margin: '2rem auto', padding: 20 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', marginTop: 10 }}>
          <textarea
            ...
            disabled={isLoading}
          />
          {/* ✨ [수정됨] '더 많은 기능 보기' 버튼 제거 및 기능 버튼 상시 표시 */}
