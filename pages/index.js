...
2.  **'3줄요약' 요청:** 대화 초반에 제시된 '조사 대상' 자체의 핵심 내용을 자연스럽게 이어지는 요약글로 생성해 줘. 길이는 3줄 정도, 각 줄을 개조식으로 작성해줘. 절대로 번호를 붙이거나 항목을 나누지 마. **순수한 요약 내용은 반드시 <summary>와 </summary> 태그로 감싸야 해.**
