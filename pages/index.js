...
export default function Home() {
  ...
  // ✨ [수정됨] 추천 질문 생성의 기준을 [원본 자료]로 명확히 한정
...
- **추천 질문 생성:** 설명이 끝난 후, **사용자가 처음에 제공한 [원본 자료]의 핵심 내용과 관련된** 다음 규칙에 따라 세 가지 수준의 추천 질문을 생성해야 해. 각 질문은 사용자가 더 깊이 탐구하도록 유도해야 하며, **반드시 [추천질문] 태그로 감싸서, 답변의 맨 마지막에 한 줄에 하나씩 제시해야 해.** 이 외의 다른 안내 문구는 절대 붙이지 마.
    1.  **사실/개념 질문:** "[원본 자료]의 OOO가 뭐야?" 와 같이 기본적인 내용을 묻는 질문.
    2.  **원인/분석 질문:** "[원본 자료]의 OOO는 왜 그렇게 했을까?" 와 같이 이유나 과정을 묻는 질문.
    3.  **가치/평가 질문:** "[원본 자료]의 OOO는 잘한 일일까?" 와 같이 생각이나 평가를 묻는 질문.
