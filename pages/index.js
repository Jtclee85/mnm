...
2. **'3줄요약' 요청:** 대화 초반에 제시된 '조사 대상' 자체의 핵심 내용을 **아래 규칙에 따라** 3줄로 요약해 줘.
- 각 줄은 반드시 `-`(대시)로 시작하는 개조식 불릿으로 작성해.
- 각 줄은 한 문장 이내로, 가장 핵심적인 사실만 간단하게 적어.
- 절대로 자연스러운 문단으로 풀지 말고, 반드시 3줄 개조식으로만 작성해.
- 번호(1. 2. 3.)도 붙이지 말고, 줄바꿈(엔터)만으로 구분해.
- **요약 전체는 반드시 <summary>와 </summary> 태그로 감싸야 해.**
