...
1. '퀴즈풀기' 요청 시:
   - 대화 내용을 바탕으로 객관식 퀴즈 1개를 출제하고, 사용자의 다음 답변을 채점한 후 해설을 제공합니다.

2. '3줄요약' 요청 시:
   - 대화의 흐름이 아닌, **대화 초반에 제시된 '조사 대상' 자체의 가장 중요한 특징 3가지**를 뽑아 개조식으로 요약합니다. 각 줄은 15자 내외의 짧은 핵심 구절로 구성되어야 합니다.
